  ...
  return (
    <div className="flex flex-col pb-16">
      ...
      <section className="relative px-6 pt-16 pb-12 flex flex-col items-center text-center max-w-7xl mx-auto perspective-2000">
        ...
        <div className="group relative inline-flex items-center gap-3 px-5 py-2 rounded-full border border-teal-500/10 bg-[#0a1211] md:bg-teal-500/5 md:backdrop-blur-xl mb-8 overflow-hidden transition-all duration-700 hover:border-teal-500/30 animate-reveal-up shadow-[0_0_30px_rgba(45,212,191,0.03)]">
          <div className="relative w-1.5 h-1.5">
            <div className="absolute inset-0 bg-teal-500 rounded-full animate-[ping_4s_cubic-bezier(0,0,0.2,1)_infinite] opacity-20"></div>
        ...
        <div className="max-w-4xl mb-8 animate-reveal-up" style={{ animationDelay: '0.1s' }}>
          <p className="text-teal-500/80 text-sm md:text-base font-semibold uppercase tracking-[0.2em]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full animate-reveal-up" style={{ animationDelay: '0.3s' }}>
          {[
            ...
            <div key={i} className="px-6 py-6 rounded-2xl bg-white/[0.02] border border-white/5 text-left transition-colors hover:bg-white/[0.04]">
              <div className="text-[9px] font-bold text-teal-500/50 uppercase tracking-widest mb-1.5">{item.label}</div>
      ...
      {/* Audit Cover Section */}
      <section className="px-6 max-w-7xl mx-auto w-full py-24 border-t border-white/5">
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-center mb-4 text-white">
          The System Audit Covers.
        </h2>
        <p className="text-neutral-400 text-center mb-16 font-medium uppercase tracking-[0.15em] text-xs">A diagnostic review of your outbound pipeline.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="p-10 rounded-3xl bg-neutral-900/20 border border-white/5 shadow-xl hover:border-white/10 transition-colors">
              <h3 className="text-teal-400 font-semibold mb-4 text-lg flex items-center gap-3">
                <span className="text-[10px] text-teal-500/30 font-mono">0{i+1}</span>
                {item.t}
              </h3>
      ...
      <section className="px-6 max-w-7xl mx-auto w-full py-24 border-t border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-neutral-400 text-lg font-medium mb-10 leading-relaxed max-w-lg">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-white/[0.01] border border-white/5 flex gap-6 hover:bg-white/[0.02] transition-colors">
                <div className="w-10 h-10 rounded-xl bg-teal-500/5 flex items-center justify-center flex-shrink-0 text-teal-500 font-bold">/</div>
                <div>
      ...
      <section className="px-6 max-w-7xl mx-auto w-full py-24 border-y border-white/5 bg-white/[0.005]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-teal-500/50 mb-6 block">PHASE-1 RESULT</span>
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div key={i} className="flex items-center gap-4 px-8 py-5 rounded-2xl bg-neutral-900/40 border border-white/5">
                <div className="w-1 h-1 rounded-full bg-teal-500/60" />
                <span className="text-[11px] text-neutral-300 font-bold uppercase tracking-widest">{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 max-w-7xl mx-auto w-full py-24">
        <div className="p-12 md:p-16 rounded-[4rem] border border-white/5 bg-neutral-900/50 md:backdrop-blur-xl shadow-2xl relative overflow-hidden">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex gap-4 items-start text-neutral-300 font-medium">
                    <div className="w-1 h-1 rounded-full bg-teal-500/40 mt-3 flex-shrink-0" />
      ...
      <section className="px-6 py-24 flex flex-col items-center text-center">
        <div className="w-full max-w-5xl p-16 md:p-24 rounded-[4rem] bg-gradient-to-b from-neutral-900/40 to-neutral-900/10 border border-white/5 relative overflow-hidden group shadow-[0_50px_100px_rgba(0,0,0,0.4)]">
          <div className="absolute inset-0 bg-teal-500/[0.02] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
